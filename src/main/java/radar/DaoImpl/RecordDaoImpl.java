...
public class RecordDaoImpl implements RecordDao{
	...
	public List<Record> getAllRecords() {
		...
		@SuppressWarnings("unchecked")
		@Override
		public 	List<Record> slectRecordByManager(Integer managerId,String startTimeDate,String endTimeDate){
			EntityManager em = emf.createEntityManager();
			String selectSql = "select * from record where radar_id in(select radar_id from radar where manager_id='"+managerId+"') and  record_start_date >='"+startTimeDate+"'  and record_end_date <='"+endTimeDate+"'";
			Query query = em.createNativeQuery(selectSql,Record.class);
			List<Record> list = query.getResultList();
			em.close();
			return list;
