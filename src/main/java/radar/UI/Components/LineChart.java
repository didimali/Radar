...
import radar.SwingWorker.SwingWorkerForLineChart;
...
public class LineChart extends JPanel{
	...
	public LineChart(String title,String xTitle,String yTitle,String className,String methodName) {
		this.title = title;
		this.xTitle = xTitle;
		this.yTitle = yTitle;
	...
	public void init() {
		...
		//查询加载数据		
		SwingWorkerForLineChart swl = new SwingWorkerForLineChart(this, className, methodName);
		swl.execute();
